                        ...
                        return (
                          ...
                          >
                            <div className="flex h-full w-full flex-col">
                              ...
                              <div className="mt-auto flex min-h-0 w-full flex-col justify-end gap-0.5 pt-1 md:gap-1 md:pt-2">
                                <div className="flex min-h-[17px] w-full flex-1 items-center justify-center md:min-h-[20px]">
                                  <span
                                    style={{ visibility: typeCounts.선착순 === 0 ? "hidden" : "visible" }}
                                    className="inline-flex h-[17px] min-w-[28px] items-center justify-center rounded-full bg-sky-50 px-1.5 py-0.5 text-[10px] font-medium leading-none text-sky-700 ring-1 ring-sky-200 md:h-[20px] md:min-w-[32px] md:text-[11px]"
                                  >
                                    {typeCounts.선착순}
                                  </span>
                                </div>
                                ...
                                <div className="flex min-h-[17px] w-full flex-1 items-center justify-center md:min-h-[20px]">
                                  <span
                                    ...
                                    className="inline-flex h-[17px] min-w-[28px] items-center justify-center rounded-full bg-amber-50 px-1.5 py-0.5 text-[10px] font-medium leading-none text-amber-700 ring-1 ring-amber-200 md:h-[20px] md:min-w-[32px] md:text-[11px]"
                                  >
                                    {typeCounts.추첨접수}
                                  </span>
                                </div>
                                ...
                                <div className="flex min-h-[17px] w-full flex-1 items-center justify-center md:min-h-[20px]">
                                  <span
                                    ...
                                    className="inline-flex h-[17px] min-w-[28px] items-center justify-center rounded-full bg-violet-50 px-1.5 py-0.5 text-[10px] font-medium leading-none text-violet-700 ring-1 ring-violet-200 md:h-[20px] md:min-w-[32px] md:text-[11px]"
                                  >
                                    {typeCounts.추첨발표}
                                  </span>
                                </div>
                                ...
                                <div className="flex min-h-[17px] w-full flex-1 items-center justify-center md:min-h-[20px]">
                                  <span
                                    ...
                                    className="inline-flex h-[17px] min-w-[28px] items-center justify-center rounded-full bg-rose-50 px-1.5 py-0.5 text-[10px] font-medium leading-none text-rose-700 ring-1 ring-rose-200 md:h-[20px] md:min-w-[32px] md:text-[11px]"
                                  >
                                    {typeCounts["미결제/대기예약"]}
                                  </span>
                                </div>
